...
const Index = () => {
  ...
  const pricingData = {
    '1-connection': {
      name: "1 Device",
      prices: {
        'starter': { name: 'Starter', price: '10$', period: '/month', savings: '', duration: '1 Month' },
        'pro': { name: 'Pro', price: '25$', period: '/3 months', savings: 'Save 15%', duration: '3 Months' },
        'max': { name: 'Max', price: '45$', period: '/6 months', savings: 'Save 23%', duration: '6 Months' },
        'legend': { name: 'Legend', price: '65$', period: '/12 months', savings: 'Save 36% – Best Value', duration: '12 Months' }
      }
    },
    '2-connections': {
      name: "2 Devices",
      prices: {
        ...
        'max': { name: 'Max', price: '75$', period: '/6 months', savings: 'Save 25%', duration: '6 Months' },
    ...
    '3-connections': {
      ...
      prices: {
        ...
        'max': { name: 'Max', price: '115$', period: '/6 months', savings: 'Save 20%', duration: '6 Months' },
        'legend': { name: 'Legend', price: '175$', period: '/12 months', savings: 'Save 33% – Best Value', duration: '12 Months' }
      }
    }
  };
